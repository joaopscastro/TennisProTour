...
export function buildDependencies(options: CompositionOptions): Dependencies {
  ...
  return {
    ...
    promoteQualifiers: new PromoteQualifiersUseCase(tournaments, bracketGenerator, players),
    ...
    promoteDoublesQualifiers: new PromoteDoublesQualifiersUseCase(tournaments, bracketGenerator, players),
